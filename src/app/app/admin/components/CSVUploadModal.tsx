    ...
    const processFile = (file: File) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                const hasIdColumn = headers.some(h => ['id', 'codigo', 'cod_ibge'].includes(h));
                if (!hasIdColumn) {
                    setErrors(['O CSV precisa ter uma coluna "id", "codigo" ou "cod_ibge"']);
                    return;
                }
                ...
                rows.forEach((row, index) => {
                    ...
                    if (city) {
                        ...
                        parseErrors.push(`Linha ${index + 2}: ID não encontrado ou inválido`);
                    }
                });
